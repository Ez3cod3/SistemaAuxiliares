                ...
                <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                    <div class="panel panel-success">
                        <div class="panel-heading">
                            <i class="fa fa-user"></i>Paso 5 - Listado de Tematicas para las pruebas escritas <?php  echo "".$cod."";?>
                        </div>
                        <!-- /.panel-heading -->
								...
								<div class="table-responsive">
									...
									<div class="control-group">
										<div class="controls">
											...
											<a href="lista_con.php"  class="btn btn-primary btn-sm"></i> Finalizar  </a>
		...
		<div class="modal-dialog">
			<div class="modal-content">
				...
				<div class="modal-body">
					<form class="form-signin" action="lista_con.php?cod=<?php echo"$cod" ?>" method="post" enctype="multipart/form-data">
						<div class="col-xs-12 col-sm-12 col-md-3 col-lg-3">
							<label>Selecione Tematica</label>
						</div>
						...
						<div class="col-xs-12 col-sm-12 col-md-3 col-lg-3">
							<label>Selecione Auxiliatura</label>
						</div>
						<div class="col-xs-12 col-sm-12 col-md-9 col-lg-9">
							<div class="input-group">
								<span class="input-group-addon" ></span>
