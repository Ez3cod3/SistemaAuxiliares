                ...
                <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                    <div class="panel panel-success">
                        <div class="panel-heading">
                            <i class="fa fa-user"></i> Listado de Requisitos - <?php  echo "".$cod."";?>
                        </div>
                        <!-- /.panel-heading -->
					...
					<form class="form-signin" action="new_requisito.php?cod=<?php echo"$cod" ?>" method="post" enctype="multipart/form-data">
						...
						<div class="col-xs-12 col-sm-12 col-md-9 col-lg-9">
							<div class="input-group">
								...
								<input type="text" class="form-control" name="requisito" id="requisito" required placeholder="Escriba el Requisito">
							</div>
						</div>
